...
#ATS MoV values
if ($useATSmValues == 1) {    #currrently no web interface to use these values. have to specify in URL
...
if ($useATSmValues == 0) {
 print "<p><a href=\"/cgi-bin/agaMatrix.cgi?useMarginOfVictory=yes&useATSmValues=yes\">Recompute with ATS predictive team rankings</a>   </p> ";
}
