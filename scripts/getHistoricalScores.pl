...
unless ($#ARGV == 0) { 
print "usage: getHistoricalScores.pl YEAR\n";
exit;
} 



my $seasonYear = $ARGV[0];


my $ncfScoresFile = "/home/neville/cfbPlayoffPredictor/data/$seasonYear/week17/ncfScoresFile.txt";
...
$confId = $ops[0];
$seasonYear = $ops[1];
$seasonType = $ops[2];   #not used
$weekNumber = $ops[3];


my $baseurl ="http://scores.espn.go.com/college-football/scoreboard/_/group/$confId/year/$seasonYear/week/$weekNumber";
