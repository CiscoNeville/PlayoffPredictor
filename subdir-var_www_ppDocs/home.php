...
echo "$line";
  ...
  <h4>Playoff Predictor for the 2022 college football season</h4>
...
echo '<table><p>First predicted committee top 4 of the season will be available after the first committee poll is released (November 1st, 2022)</p></table> ';
}
...
<hr>
  	...
  	<br><br>
  	True ratings are computed by a <a href="/faq.php#Modified">variant</a> of the <a href="http://www.colleyrankings.com">Colley Matrix method</a>
...
echo "<h4><a href=\"/predictFutureWeeks-unified.php?app=no&top15=yes&fullSeason=no\">Try it yourself now! Select the $nextWeekUp game winners and determine what the $nextPollUp poll will look like now </a></h4><br>   ";
   ...
   ?>  
  	...
  	<td class="bucket2"><center><a href="/2022NcfRatingBiases.php">  Average Committee Bias </a> --
...
<p style="vertical-align: middle;"> We now have an iTunes app! Try it now -> 
	<a href="https://itunes.apple.com/us/app/college-football-playoff-predictor/id1280755736?mt=8"><img src="Download_on_the_App_Store_Badge_US-UK_135x40.svg" style="vertical-align: middle;"></a>
</p>
    </body>
