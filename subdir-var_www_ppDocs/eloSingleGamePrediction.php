...
<p>Here you can use an Elo-based calculation to predict the winning probailities for two given teams.  The winning probabilities are based soley on the ratings of each team and do not take in to consideration home field.</p>
