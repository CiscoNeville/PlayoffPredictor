...
$winBgColor = "#00A000";      #start with a standard <17 point win color
if ($hTotal > $aTotal + 16) {$winBgColor = "#009000";}
if ($hTotal > $aTotal + 32) {$winBgColor = "#008000";}
$q = $teamH[$aTeamName];
...
$lossBgColor = "#A00000";      #start with a standard <17 point loss color
if ($hTotal < $aTotal + 16) {$lossBgColor = "#B00000";}
if ($hTotal < $aTotal + 32) {$lossBgColor = "#C00000";}
$q = $teamH[$aTeamName];
$p = ($teamRk[$q] * 8) + 290;
$o = (($colNum - 1) * 379) + 16;
...
$winBgColor = "#00A000";      #start with a standard <17 point win color
if ($aTotal > $hTotal + 16) {$winBgColor = "#009000";}
if ($aTotal > $hTotal + 32) {$winBgColor = "#008000";}
 $q = $teamH[$hTeamName];
 $p = ($teamRk[$q] * 8) + 290;
 $o = (($colNum - 1) * 379) + 16;
...
echo "<td>";			
echo "<table bgcolor =\"#FFFFFF\" border=\"0px\" cellpadding=\"\" cellspacing=\"\" width=\"359px\" height=\"1090px\"  frame=\"box\">";
...
$q = $teamH[$teamIn];
$o = (($colNum - 1) * 379) + 16;
print "<tr><th><DIV id=\"inner\" style=\"position: absolute; top:280px; left:$o"."px; width:350px; height:20px;\"> <font color=\"#000040\">           #$teamRk[$q] $teamIn ($wins-$losses)  -  $teamR[$teamIn] </font></div>   </th></tr>";  
print "	<tr><td> <DIV id=\"inner\" style=\"position: absolute; top:288px; left:$o"."px; width:350px; height:4px;\">       <hr>      </div></td></tr>";
...
<DIV id="inner" style="position: absolute; top:1400px; left:0px; width:350px; height:20px;">
